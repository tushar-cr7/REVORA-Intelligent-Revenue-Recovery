    ...
    <div className="bg-panel border border-border-strong rounded-xl p-5 shadow-sm h-full flex flex-col justify-between">
      <div>
        ...
        <div className="mt-3 flex items-center gap-2">
          ...
          <span className={`font-display font-semibold text-lg tracking-tight ${state.text}`}>{state.label}</span>
        </div>

        <div className="mt-3 h-px bg-gradient-to-r from-border-strong via-border-subtle to-transparent" />
