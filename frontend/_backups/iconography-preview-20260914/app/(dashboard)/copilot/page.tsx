...
import { Bot, Send, Sparkles, Activity, Layers, CornerDownRight } from 'lucide-react';
    ...
    <div className="p-4 lg:p-6 space-y-6 max-w-[1600px] mx-auto w-full flex flex-col min-h-[calc(100vh-2rem)] pb-8 relative">
      ...
      <div className="flex items-center justify-between relative z-10">
        <div className="flex items-center space-x-4">
          <div className="w-10 h-10 rounded-xl bg-surface border border-border-strong flex items-center justify-center text-ai-400 shadow-[0_0_15px_rgba(168,85,247,0.1)]">
        ...
        <div className="lg:col-span-4 xl:col-span-3 space-y-6">
          ...
          <div className="bg-panel border border-border-strong rounded-xl flex flex-col h-[400px] lg:h-[500px] shadow-sm overflow-hidden">
            <div className="p-5 border-b border-border-subtle bg-surface/50 flex items-center space-x-3">
              <div className="w-8 h-8 rounded-lg bg-primary-900/10 border border-primary-500/20 flex items-center justify-center text-primary-400">
