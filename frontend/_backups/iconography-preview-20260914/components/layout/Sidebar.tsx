...
const navGroups = [
  {
    ...
    items: [
      ...
      { href: '/revenue-scanner', label: 'Revenue Scanner', icon: Radar },
      { href: '/recovery-brain', label: 'Recovery Brain', icon: BrainCircuit },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/policies', label: 'Recovery Controls', icon: ShieldCheck },
      { href: '/escalations', label: 'Escalations', icon: AlertTriangle },
      { href: '/audit', label: 'Audit Trail', icon: FileSpreadsheet },
    ]
  },
  {
    title: 'Intelligence',
    items: [
      ...
      { href: '/integrations', label: 'Integrations', icon: Sliders },
    ...
    <aside className="w-64 bg-surface border-r border-border-subtle flex flex-col justify-between shrink-0 hidden md:flex">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <Icon className={`w-4 h-4 ${isActive ? 'text-primary-400' : 'text-text-muted group-hover:text-text-secondary'} transition-colors`} />
      ...
      <div className="p-4 border-t border-border-subtle">
        <div className="space-y-1 mb-4">
          ...
          >
            <div className="flex items-center space-x-3">
              <Bot className={`w-4 h-4 ${pathname.startsWith('/copilot') ? 'text-ai-400' : 'text-text-muted'}`} />
