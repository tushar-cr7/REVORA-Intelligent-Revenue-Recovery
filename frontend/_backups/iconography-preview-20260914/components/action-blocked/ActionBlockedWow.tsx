...
import { ShieldAlert, AlertTriangle, ArrowRight, CheckCircle2, RefreshCw, Hexagon, Shield, BrainCircuit } from 'lucide-react';
              ...
              <div className="p-4 rounded-xl bg-ai-900/10 border border-ai-500/20 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between font-mono font-medium mb-3">
                    <span className="text-ai-400 text-[11px] tracking-widest uppercase flex items-center"><BrainCircuit className="w-3.5 h-3.5 mr-1.5" /> Intelligence Engine</span>
                  </div>
