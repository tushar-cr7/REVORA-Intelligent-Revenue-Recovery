...
import { FileSpreadsheet, ShieldCheck, ShieldAlert, CheckCircle2, AlertTriangle, Layers } from 'lucide-react';
    ...
    <div className="bg-panel border border-border-strong rounded-xl p-5 shadow-sm">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-border-subtle">
        <div className="flex items-center space-x-3">
          <div className="w-8 h-8 rounded-lg bg-surface border border-border-subtle flex items-center justify-center text-text-secondary">
              ...
              <tr>
                <td colSpan={6} className="py-12 text-center text-text-muted border-b border-dashed border-border-subtle">
                  <div className="flex flex-col items-center">
                    <FileSpreadsheet className="w-8 h-8 text-text-muted/50 mb-3" />
