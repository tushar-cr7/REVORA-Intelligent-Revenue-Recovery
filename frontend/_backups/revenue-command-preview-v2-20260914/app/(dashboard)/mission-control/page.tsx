...
import { RecoveryPulseHeader } from '@/components/kpi/RecoveryPulseHeader';
import { RecoveryStatusPanel } from '@/components/kpi/RecoveryStatusPanel';
import { RevenueRiskMap } from '@/components/revenue-leak/RevenueRiskMap';
import { RevoraActivity } from '@/components/recovery-brain/RevoraActivity';
...
export default function MissionControlPage() {
  ...
  return (
    ...
    >
      ...
      {/* 1. Recovery Pulse — the financial story as one connected hero */}
      <motion.div variants={item}>
        <RecoveryPulseHeader scanData={scanData} analyzeData={analyzeData} recoverData={recoverData} />
      </motion.div>

      {/* 2. Where it is & what REVORA is doing */}
      <motion.div variants={item} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <RevenueRiskMap scanData={scanData} analyzeData={analyzeData} />
        <RevoraActivity analyzeData={analyzeData} auditLog={auditLog} />
      </motion.div>
